...
mod tests {
    ...
    async fn setup_database() -> DatabaseConnection {
        ...
        let soilprofile_stmt = schema
            .create_table_from_entity(crate::routes::soil::profiles::db::Entity)
            .clone();
        ...
        let project_stmt = schema
            .create_table_from_entity(crate::routes::projects::db::Entity)
            .clone();
        ...
        let area_stmt = schema
            .create_table_from_entity(crate::routes::areas::db::Entity)
            .clone();
        ...
        let soiltype_stmt = schema
            .create_table_from_entity(crate::routes::soil::types::db::Entity)
            .clone();
    ...
    async fn create_dummy_entities(
        ...
        let dummy_soiltype = crate::routes::soil::types::db::ActiveModel {
        ...
        crate::routes::soil::types::db::Entity::insert(dummy_soiltype)
            .exec(db)
            .await
            .unwrap();
        ...
        let dummy_project = crate::routes::projects::db::ActiveModel {
        ...
        crate::routes::projects::db::Entity::insert(dummy_project)
            .exec(db)
            .await
            .unwrap();
        ...
        let dummy_area = crate::routes::areas::db::ActiveModel {
        ...
        crate::routes::areas::db::Entity::insert(dummy_area)
            .exec(db)
            .await
            .unwrap();
