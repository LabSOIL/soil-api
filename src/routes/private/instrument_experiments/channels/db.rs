...
pub enum Relation {
    #[sea_orm(
        belongs_to = "crate::routes::private::instrument_experiments::db::Entity",
        from = "Column::ExperimentId",
        to = "crate::routes::private::instrument_experiments::db::Column::Id",
        on_update = "NoAction",
        on_delete = "NoAction"
    )]
...
impl Related<crate::routes::private::instrument_experiments::db::Entity> for Entity {
    fn to() -> RelationDef {
