...
impl CRUDResource for SoilType {
    type EntityType = crate::routes::private::soil::types::db::Entity;
    type ColumnType = crate::routes::private::soil::types::db::Column;
    type ActiveModelType = crate::routes::private::soil::types::db::ActiveModel;
