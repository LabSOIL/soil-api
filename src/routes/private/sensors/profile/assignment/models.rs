...
pub struct SensorProfileAssignment {
    ...
    #[crudcrate(update_model = false, create_model = false)]
    pub sensor: Option<crate::routes::private::sensors::models::Sensor>,
    #[serde(default)]
...
impl CRUDResource for SensorProfileAssignment {
    ...
    async fn get_all(
        ...
        let sensor_profile: crate::routes::private::sensors::profile::models::SensorProfile =
            models
                .load_one(crate::routes::private::sensors::profile::db::Entity, db)
                .await?
                .pop()
                .unwrap()
                .unwrap()
        ...
        let sensor: crate::routes::private::sensors::models::Sensor = models
            .load_one(crate::routes::private::sensors::db::Entity, db)
            .await?
            .pop()
            .unwrap()
            .unwrap()
    ...
    async fn get_one(db: &DatabaseConnection, id: Uuid) -> Result<Self, DbErr> {
        ...
        let sensor_profile: crate::routes::private::sensors::profile::models::SensorProfile = model
            .clone()
            .load_one(crate::routes::private::sensors::profile::db::Entity, db)
            .await?
            .pop()
        ...
        let sensor: crate::routes::private::sensors::models::Sensor = model
            .clone()
            .load_one(crate::routes::private::sensors::db::Entity, db)
            .await?
            .pop()
