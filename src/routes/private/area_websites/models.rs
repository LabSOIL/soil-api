...
impl From<Model> for AreaWebsite {
...
#[async_trait]
impl CRUDResource for AreaWebsite {
    type EntityType = super::db::Entity;
    type ColumnType = super::db::Column;
    type ActiveModelType = super::db::ActiveModel;
    type CreateModel = AreaWebsiteCreate;
    type UpdateModel = AreaWebsiteUpdate;

    const ID_COLUMN: Self::ColumnType = super::db::Column::Id;
    const RESOURCE_NAME_PLURAL: &'static str = "area_websites";
    const RESOURCE_NAME_SINGULAR: &'static str = "area_website";
    const RESOURCE_DESCRIPTION: &'static str = "Links areas to websites with optional date restrictions.";
